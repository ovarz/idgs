<nav class="mobile-only">
  ...
  class="sticky-link <?php if($channel == 'wifi-coin') { ?>sticky-curr<?php } ?> wifi-coin-button content_center">
    <?php require ($_SERVER['IDGS'].'img/icon/home.svg')?>
	<span class="sticky-label">Wifi Coin</span>
  </a>
  <button title="Cari" 
  class="sticky-link <?php if($channel == 'cari') { ?>sticky-curr<?php } ?> open-sticky sticky-search-open content_center">
